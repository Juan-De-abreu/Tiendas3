            ...
            <div className="row gx-0 align-items-center">
              <div className="col-lg-8 text-center text-lg-center mb-lg-0">
                <div className="d-flex flex-wrap">
                  <div className="pe-4">
                    <a href="#" className="text-muted small"><i className="fas fa-comment-dots text-primary me-2" />Juan De Abreu</a>
                  </div>
                  <div className="pe-0">
            ...
            <nav className="navbar navbar-expand-lg navbar-light d-flex justify-content-lg-end">
              ...
              <div className="collapse navbar-collapse" id="navbarCollapse">
                <div className="navbar-nav mx-0 mx-lg-auto">
                  <Link to="/celulares" className={`nav-item nav-link ${location.pathname === '/celulares' ? 'active' : ''} text-white`} >Celulares</Link>
                  <Link to="/laptops" className={`nav-item nav-link ${location.pathname === '/laptops' ? 'active' : ''} text-white`}>Laptops</Link>
                  <Link to="/tienda" className={`nav-item nav-link ${location.pathname === '/tienda' ? 'active' : ''} text-white`}>Tienda</Link>

                  <div className="nav-item dropdown">
                    <a href="#" className="nav-link" data-bs-toggle="dropdown">
                      <span className="dropdown-toggle text-white">Categorias</span>
                    </a>
